...
async def _process_upload(file: UploadFile, doc_type: str) -> DocumentUploadResponse:
    """
...
async def upload_vendor_document(
    ...
    return await _process_upload(file, doc_type="vendor")
...
async def upload_tender_document(
    ...
    return await _process_upload(file, doc_type="tender")
