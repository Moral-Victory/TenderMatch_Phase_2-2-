...
import { matchVendor, getIndexStatus } from '../services/documentService';
import type { MatchResult, IndexStatus } from '../types/document';
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="e.g. 67db1a2c3f4e5d6a7b8c9d0e"
                                className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl text-sm font-mono
                                           focus:outline-none focus:border-[#c41230] focus:ring-2 focus:ring-[#c41230]/10 transition"
                                onKeyDown={e => e.key === 'Enter' && run()}
                            />
                        </div>
                        <p className="text-xs text-slate-400 mt-1.5">
                            Copy this from the Upload page or the MongoDB <code>documents</code> collection.
                        </p>
                    </div>
